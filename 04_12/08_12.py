...
class SuperHuman:
	def greet(self, title = 'Mr'):
		self.title = title
		print("I am the Law")
	def fly(self, title = 'Mr'):
		print('fly')


class Worker(MyClass, SuperHuman):
	...
	@staticmethod
	def static_method(): 				#позволяет вызывать данную функцию ото всюду и без w1.
		print("staticmethod")

	@classmethod
	def class_method(cls,a,b,c=None):
		print(cls)
		print(a,b,c)
